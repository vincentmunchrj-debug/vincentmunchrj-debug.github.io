...
const DICT = {
  pt: {
    ...
    open: 'aberto',
    live: '🔴 AO VIVO',
    livePick: 'Seu palpite',
    savePick: 'Salvar palpite',
    saved: '✓ Salvo!',
    modifyPick: 'Modificar',
    ...
    halftime: 'Intervalo',
    koInfoTitle: 'Jogos do mata-mata',
    koInfoText: 'Nos jogos do mata-mata, você pode escolher o empate: aparece então uma linha abaixo para escolher o vencedor nos pênaltis. Boa sorte a todos!',
    koInfoBtn: 'Fechar',
    photoInfoTitle: 'Fotos no chat',
    photoInfoText: 'Novidade! Agora você pode enviar fotos no chat do Studio. Toque no ícone 📷 ao lado do campo de mensagem, escolha uma foto (ou tire na hora) e envie. Você pode escrever uma legenda antes de enviar. Toque numa foto recebida para ampliá-la.',
    photoInfoBtn: 'Entendi!',
    liveRanking: 'Classificação provisória',
    yourPickLive: 'Seu palpite',
    livePoints: (n) => `+${n} pts agora`,
    liveNoPoints: 'Sem pontos',
    phaseLabel: {
    ...
    shootout: (h, a) => `${h}-${a} nos pênaltis`,
    chatTitle: 'Chat do Studio',
    chatPlaceholder: 'Mensagem… (use @ para citar alguém)',
    chatSend: 'Enviar',
    seeOriginal: 'ver original',
    chatEmpty: 'Seja o primeiro a escrever! 💬',
    // Champion
  ...
  fr: {
    ...
    navLive: 'En direct',
    noLive: 'Aucun match en direct pour l\'instant.',
    halftime: 'Mi-temps',
    koInfoTitle: 'Matchs à élimination directe',
    koInfoText: 'Dans les matchs à élimination directe, vous pouvez opter pour le match nul : une ligne apparaît alors en dessous pour choisir le vainqueur aux tirs au but. Bonne chance à tous !',
    koInfoBtn: 'Fermer',
    photoInfoTitle: 'Photos dans le chat',
    photoInfoText: 'Nouveauté ! Vous pouvez maintenant envoyer des photos dans le chat du Studio. Touchez l\'icône 📷 à côté du champ de message, choisissez une photo (ou prenez-en une), et envoyez-la. Vous pouvez écrire une légende avant d\'envoyer. Touchez une photo reçue pour l\'agrandir.',
    photoInfoBtn: 'Compris !',
    liveRanking: 'Classement provisoire',
    yourPickLive: 'Votre prono',
    livePoints: (n) => `+${n} pts maintenant`,
    liveNoPoints: 'Pas de points',
    phaseLabel: {
      r32: '16es de finale',
      r16: '8es de finale',
    ...
    shootout: (h, a) => `${h}-${a} aux t.a.b.`,
    chatTitle: 'Chat du Studio',
    chatPlaceholder: 'Message… (utilisez @ pour mentionner)',
    chatSend: 'Envoyer',
    seeOriginal: "voir l'original",
    chatEmpty: 'Soyez le premier à écrire ! 💬',
