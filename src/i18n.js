...
const DICT = {
  pt: {
    ...
    pubCreate: '+ Criar meu grupo',
    pubInviteNote: 'Recebeu um convite? Abra o link enviado pelo seu amigo.',
  ...
  fr: {
    ...
    pubCreate: '+ Créer mon groupe',
    pubInviteNote: 'Tu as reçu une invitation ? Ouvre le lien envoyé par ton ami.',
